...
<table width="100%" border="0" style="border: none;">
  <tr>
    <td width="65%" valign="top">
      <ul>
        <li>🔭 <b>I’m currently working on:</b> Building advanced UI systems, AI-based personality analyzers, and exploring system-level projects like simulations & full-stack platforms</li>
        <li>🌱 <b>I’m currently learning:</b> Operating Systems, System Design, DevOps fundamentals, and diving deeper into AI + Backend Engineering</li>
        <li>👯 <b>I’m looking to collaborate on:</b> High-tech projects (AI tools, system simulations, futuristic UI/UX, open-source dev tools)</li>
        <li>🤔 <b>I’m looking for help with:</b> Scaling complex systems, advanced backend architecture, and real-world DevOps pipelines</li>
        <li>💬 <b>Ask me about:</b> Programming, System Design, UI/UX ideas, AI projects, or just building something cool together 😎</li>
        <li>📫 <b>How to reach me:</b> <a href="mailto:rupamroychoudhury2008@gmail.com">rupamroychoudhury2008@gmail.com</a></li>
        <li>😄 <b>Pronouns:</b> He/Him</li>
        <li>⚡ <b>Fun fact:</b> I don’t just use technology… I try to <i>understand and bend it</i> 🚀</li>
      </ul>
    </td>
...
<table width="100%" border="0" style="border: none;">
  <tr align="center">
    <td width="33%"><b>🧠 Human Traits Analyzer</b></td>
    <td width="33%"><b>🛡️ AI Vulnerability Scanner</b></td>
    <td width="33%"><b>🌱 Green Sathi</b></td>
  </tr>
  <tr align="center" valign="top">
    <td><sup>An AI-powered analysis tool that evaluates raw text and messages to detect underlying sentiment and extract granular emotions.</sup></td>
    <td><sup>An AI-assisted cybersecurity tool that scans network targets, evaluates risk levels using ML, and provides actionable recommendations.</sup></td>
    <td><sup>An AI-powered crop disease prediction system that analyzes plant conditions to help farmers take preventive action.</sup></td>
  </tr>
</table>
  ...
  <tr>
    ...
    <td align="center" width="50%">
      <a href="https://leetcode.com/rupam654_">
        <img src="https://leetcard.jacoblin.cool/rupam654_?theme=dark&font=Syne&ext=activity" alt="LeetCode Stats" width="100%" />
      </a>
    </td>
  </tr>
</table>
